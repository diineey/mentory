...
import { MentorDetailsFormEmits, MentorDetailsFormProps } from '@/entities/mentor/mentor-details.types.js'
...
<template>
  <div class="mentors-cards-wrapper">
    <div class="mentors-card-content">
      <div class="mentor-card-price" :class="{ 'mentor-editable': props.isEditable }">
        <img class="mentors-img" src="../../assets/images/card.jpg" alt="photo">

        <p class="input-title mentor-price">Стоимость: {{ formatAmount(props.data.cost || 0) }} сум/час </p>
        ...
        <div class="mentor-sides">
          <div class="mentor-left-side">
            <div class="mentors-card-title">
              <p class="title">{{ props.data.firstname }} {{ props.data.lastname }}</p>

              <span v-if="experience" class="text">
                ({{ experience }})
              </span>
            </div>
            ...
            <p class="text">
              ...
              <span v-if="props.data.position && props.data.workplace"> - </span>

              {{ props.data.workplace }}
            </p>

            <p class="text">Язык ментора: {{ decodedLanguages || '-' }}</p>
...
<!--            <p class="text mentor-margins">0 - проведенных занятий</p>-->
        ...
        <p v-if="props.data.about" class="title-2">О себе</p>

        <p v-if="props.data.about" class="text">
          {{ props.data.about }}
        </p>
